...
}`,...(Ve=(Ce=B.parameters)==null?void 0:Ce.docs)==null?void 0:Ve.source}}};var Pe,ke,ye;q.parameters={...q.parameters,docs:{...(Pe=q.parameters)==null?void 0:Pe.docs,source:{originalSource:`() => {
  const [value, setValue] = React.useState('');
  return <>
      <Combobox value={value} onChange={val => setValue(val)} onSelect={val => {
      setValue(val);
...
}`,...(ye=(ke=q.parameters)==null?void 0:ke.docs)==null?void 0:ye.source}}};var je,Fe,we;N.parameters={...N.parameters,docs:{...(je=N.parameters)==null?void 0:je.docs,source:{originalSource:`() => {
  const [value, setValue] = React.useState('');
