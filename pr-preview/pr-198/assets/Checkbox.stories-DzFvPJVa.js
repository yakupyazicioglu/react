import{j as t}from"./index-DLccU1-8.js";import{r as v}from"./index-CBqU2yxZ.js";import{T as l}from"./component-Dob9bFSd.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-CJs1nTlS.js";import"./useId-BdPc6t19.js";import"./index.m-CtIADANO.js";import"./item-DaQZyCGt.js";import"./i18n-N9JyOJ0K.js";const Oe={title:"Forms/Toggle/Checkbox"},o=[{label:"Apple",value:"apple"},{label:"Microsoft",value:"microsoft"},{label:"Amazon",value:"amazon"}],i=()=>{const[e,c]=v.useState(!1);return t.jsx(l,{onChange:()=>c(!e),checked:e,type:"checkbox",label:"Toggle X",noVisibleLabel:!0})},p=()=>t.jsx(l,{type:"checkbox",label:"Apple",onChange:e=>console.log(e)}),d=()=>t.jsx(l,{type:"checkbox",label:"Apple",checked:!0,onChange:e=>console.log(e)}),u=()=>t.jsx(l,{type:"checkbox",label:"Apple",defaultChecked:!0,onChange:e=>console.log(e)}),a=({isInvalid:e=!1,isDisabled:c=!1})=>{const[pe,f]=v.useState(!1),[s,O]=v.useState([o[0]]),de=n=>{O(n===!1?[]:o),f(n)},ue=n=>{let r=s;s.some(T=>T.value===n.value)?r=s.filter(T=>T.value!==n.value):r=[...s,n],s.length===o.length&&f(!1),r.length===o.length&&f(!0),O(r)};return t.jsxs(t.Fragment,{children:[t.jsx(l,{onChange:de,checked:pe,type:"checkbox",label:"Select all companies",indeterminate:s.length>0&&s.length!==o.length,invalid:e,disabled:c}),t.jsx(l,{type:"checkbox",title:"Companies",options:o,selected:s,onChange:ue,invalid:e,disabled:c})]})},g=()=>t.jsx(a,{isInvalid:!0}),h=()=>t.jsx(a,{isDisabled:!0}),m=()=>t.jsx(l,{type:"checkbox",label:"Apple",helpText:"This is helper text",onChange:e=>console.log(e)}),b=()=>t.jsx(l,{type:"checkbox",options:o,onChange:e=>console.log(e)}),S=()=>t.jsx(l,{type:"checkbox",title:"Companies",options:o,onChange:e=>console.log(e)}),x=()=>t.jsx(l,{optional:!0,type:"checkbox",title:"Companies",options:o,onChange:e=>console.log(e)}),k=()=>t.jsx(l,{type:"checkbox",title:"Companies",helpText:"Select a random company",options:o,onChange:e=>console.log(e)}),C=()=>t.jsx(l,{type:"checkbox",title:"Companies",helpText:"Everything but first is selected by default",selected:[...o].splice(1),options:o,onChange:e=>console.log(e)});var y,A,j;i.parameters={...i.parameters,docs:{...(y=i.parameters)==null?void 0:y.docs,source:{originalSource:`() => {
...
}`,...(L=(H=d.parameters)==null?void 0:H.docs)==null?void 0:L.source}}};var W,M,z;u.parameters={...u.parameters,docs:{...(W=u.parameters)==null?void 0:W.docs,source:{originalSource:`() => {
  return <Toggle type="checkbox" label="Apple" defaultChecked onChange={checked => console.log(checked)} />;
}`,...(z=(M=u.parameters)==null?void 0:M.docs)==null?void 0:z.source}}};var F,U,X;a.parameters={...a.parameters,docs:{...(F=a.parameters)==null?void 0:F.docs,source:{originalSource:`({
  isInvalid = false,
  isDisabled = false
}: {
  isInvalid?: boolean;
...
}`,...(X=(U=a.parameters)==null?void 0:U.docs)==null?void 0:X.source}}};var _,R,q;g.parameters={...g.parameters,docs:{...(_=g.parameters)==null?void 0:_.docs,source:{originalSource:"() => <IndeterminateState isInvalid={true} />",...(q=(R=g.parameters)==null?void 0:R.docs)==null?void 0:q.source}}};var w,B,G;h.parameters={...h.parameters,docs:{...(w=h.parameters)==null?void 0:w.docs,source:{originalSource:"() => <IndeterminateState isDisabled={true} />",...(G=(B=h.parameters)==null?void 0:B.docs)==null?void 0:G.source}}};var J,K,N;m.parameters={...m.parameters,docs:{...(J=m.parameters)==null?void 0:J.docs,source:{originalSource:`() => {
...
}`,...(ie=(re=C.parameters)==null?void 0:re.docs)==null?void 0:ie.source}}};const Te=["SingleOptionWithInvisibleLabel","SingleOption","SingleOptionCheckedControlledDefault","SingleOptionCheckedUncontrolledDefault","IndeterminateState","Invalid","Disabled","SingleOptionHelpText","MultipleOptions","WithTitle","Optional","HelpText","SelectedDefault"];export{h as Disabled,k as HelpText,a as IndeterminateState,g as Invalid,b as MultipleOptions,x as Optional,C as SelectedDefault,p as SingleOption,d as SingleOptionCheckedControlledDefault,u as SingleOptionCheckedUncontrolledDefault,m as SingleOptionHelpText,i as SingleOptionWithInvisibleLabel,S as WithTitle,Te as __namedExportsOrder,Oe as default};
