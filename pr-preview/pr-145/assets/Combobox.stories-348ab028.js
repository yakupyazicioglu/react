...
}`,...(Re=(we=M.parameters)==null?void 0:we.docs)==null?void 0:Re.source}}};var Fe,Te,Ae;D.parameters={...D.parameters,docs:{...(Fe=D.parameters)==null?void 0:Fe.docs,source:{originalSource:`() => {
  const [value, setValue] = React.useState('');
  return <>
      <p>
        When the user clicks inside the text box the current value will be
...
}`,...(Ae=(Te=D.parameters)==null?void 0:Te.docs)==null?void 0:Ae.source}}};const ht=["Basic","DisableStaticListFiltering","BubbleEventOnEnter","MatchTextSegments","CustomMatchAlgorithm","OpenOnFocus","SelectOnClick","OptionText","WithAffix","AsyncFetch","Optional"];export{M as AsyncFetch,F as Basic,A as BubbleEventOnEnter,I as CustomMatchAlgorithm,T as DisableStaticListFiltering,E as MatchTextSegments,L as OpenOnFocus,q as OptionText,D as Optional,B as SelectOnClick,N as WithAffix,ht as __namedExportsOrder,pt as default};
//# sourceMappingURL=Combobox.stories-348ab028.js.map
